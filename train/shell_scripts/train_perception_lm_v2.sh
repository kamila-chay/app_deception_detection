...
#SBATCH -e thesis/out/logs/error_train_perception_lm_v2.txt
...
CUDA_VISIBLE_DEVICES=0,1 PYTHONPATH=./thesis:$PYTHONPATH deepspeed train_perception_lm_v2.py  --num_gpus=2