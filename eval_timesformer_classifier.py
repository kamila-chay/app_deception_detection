...
with torch.inference_mode():
    for split_id in range(1, 4):
        ...
        val_dataset = DolosClassificationDataset(f"data/val_fold{split_id}.csv", "data/video", processor)
        ...
        for epoch in range(EPOCHS):
            ...
            if val_accuracy > best_val_accuracy:
                ...
                print(f"  Best validation accuracy -> Test accuracy: {best_test_accuracy}%")
