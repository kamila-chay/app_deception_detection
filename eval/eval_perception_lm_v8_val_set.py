...
for split_id in range(1, 4):
    ...
    val_dataset = DolosDataset(
        f"thesis/data/val_fold{split_id}.csv", Path("thesis/data"), label_folder="mumin_reasoning_labels_balanced",
    ...
    for epoch in range(10):
        ...
        all_mean_cue_f1_so.append((all_f1_cue_scores[-1] + all_cue_overlap_scores[-1]) / 2)
