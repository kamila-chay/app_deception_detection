...
#SBATCH -p ampere
#SBATCH -t 1-00:00:00
#SBATCH -o thesis/out/logs/out_eval_perception_lm_v6_mrt_val_set_tau_5e-4.txt
#SBATCH -e thesis/out/logs/error_eval_perception_lm_v6_mrt_val_set_tau_5e-4.txt
